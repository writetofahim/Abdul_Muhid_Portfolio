...
const Banner = () => {
  return (
    <div
      className="bg-secondary-500 bg-no-repeat bg-right relative"
    ...
    >
      ...
      <div className=" container mx-auto flex justify-center items-center bg-no-repeat">
        <div className="w-1/2">
          <h1 className="text-[87px] leading-[80px]">
